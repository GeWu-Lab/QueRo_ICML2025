...
def get_arguments():
    ...
    parser.add_argument('--use_optical_frames', default=3, type=int)
    parser.add_argument('--csv_file', default='', type=str)
    parser.add_argument('--sub_classes', default=-1, type=int)
    parser.add_argument('--subset', default='B', type=str)
